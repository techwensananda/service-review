                          ...
                          <div class="inner-box">
                              ...
                              <div class="lower-content">
                                  ...
                                  <ul class="pt-3 post-meta justify-content-between d-flex">
                                      ...
                                      <ul>  <li><Link to={'/#'}><i class="far fa-dollar-sign"></i> 600</Link></li>
                                          </ul>
                                      <ul className='d-flex'>
                                  ...
                                  <div class="col-md-12 form-group">
                                      <Link to='/services/5' class="theme-btn btn-style-one" type="submit" name="submit-form"><span class="btn-title">Get Details</span></Link>
                                  </div>
                              </div>
                          </div>
                      </div>
